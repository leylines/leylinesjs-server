...
exports.getLineStyleMap = async function(category, solid, type) {
   let styleMap = []
...
exports.getLineStyle = async function(solids, category, solid, type, styles) {
   let style = []
...
exports.createPoint =  async function(site, description, x_coord, y_coord, z_coord, type, kmlfile) {
   kmlfile.push("      <Placemark>");
   kmlfile.push("         <styleUrl>#" + type + "</styleUrl>");
   kmlfile.push("         <name>" + site + "</name>");
