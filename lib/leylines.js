...
exports.createGrid = async function(req, res, pool) {
    ...
    switch (type) {
       case "points":
          czmlfile =  geometry.createPoints(res, yinPoints, 1, colorYin, czmlfile);
          geometry.createPoints(res, yangPoints, 1, colorYang, czmlfile);
          geometry.createPoints(res, balancedPoints, 1, colorBalance, czmlfile);
          return res.json(czmlfile);
       case "area":
          try {
             czmlfile =  geometry.createPoints(res, yinPoints, 1, colorYin, czmlfile);
       ...
       case "basic":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.basic' + shape), distanceBasic, colorBasic, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.basic' + shape), distanceBasic, colorBasic, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "tetrahedrons":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.tetrahedrons' + shape), distanceTetrahedrons, colorTetrahedrons, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.tetrahedrons' + shape), distanceTetrahedrons, colorTetrahedrons, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "cubes":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.cubes' + shape), distanceCubes, colorCubes, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.cubes' + shape), distanceCubes, colorCubes, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "yin":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.yin' + shape), distanceYin, colorYin, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.yin' + shape), distanceYin, colorYin, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "yang":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.yang' + shape), distanceYang, colorYang, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.yang' + shape), distanceYang, colorYang, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "balance":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.balance' + shape), distanceBalance, colorBalance, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.balance' + shape), distanceBalance, colorBalance, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "diamond":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.diamond' + shape), distanceDiamond, colorDiamond, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.diamond' + shape), distanceDiamond, colorDiamond, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "1":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.level1' + shape), distanceLevel1, colorLevel1, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.level1' + shape), distanceLevel1, colorLevel1, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "2":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.level2' + shape), distanceLevel2, colorLevel2, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.level2' + shape), distanceLevel2, colorLevel2, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
       case "3":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.level3' + shape), distanceLevel3, colorLevel3, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.level3' + shape), distanceLevel3, colorLevel3, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
