...
//   }
   ...
   switch (type) {
      ...
      default:
         try {
            //czmlfile = await geometry.createCorridor(czmlfile, points, solids[category][type]['lines'], solids[category][type]['distance'], solids[category][type]['color']);
            //czmlfile = await postgis.pgFindPOI(czmlfile, pool, points, solids[category][type]['lines'], solids[category][type]['distance'], solids[category][type]['color']);
