...
module.exports = function(options) {
  ...
  router.get('/exportPoints/:schema/:table/:type', function(req, res) {
      leylines.exportPOI(req, res, pool);
  });
  ...
  router.get('/exportLine/:schema/:table/:group/:width/:color', function(req, res) {
      leylines.exportLine(req, res, pool);
  });
  ...
  router.get('/exportGrid/:latitude/:longitude/:bearing/:form/:category/:solid/:type', function(req, res) {
      leylines.exportGrid(req, res, pool);
  });
  ...
  router.get('/sacredSites', function(req, res) {
      leylines.createSacredSites(req, res, pool);
  });

  router.get('/interfaithMary', function(req, res) {
      leylines.createInterfaithMarySites(req, res, pool);
  });
